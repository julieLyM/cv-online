...
import { MenuPicture, GreenLink, GreenLinkBottom } from './style/menuStyle';
  ...
  render() {
    return (
      <Menu>
        ...
        <GreenLinkBottom href={'https://github.com/julieLyM'} target="_blank">
          Github
        </GreenLinkBottom>
        <GreenLinkBottom
        ...
        <GreenLinkBottom href={cv} target="_blank" rel="noopener noreferrer">
          CV
        </GreenLinkBottom>
