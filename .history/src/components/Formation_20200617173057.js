      ...
      <FormationContainer>
        <FormationBloc>
          ...
          <AboutSimpleText>
            ...
            J'ai notamment travailler sur plusieurs projets clients comme l'application n'oublie jamais mais également un site interne
          </AboutSimpleText>
        ...
        <FormationDiv>
          ...
          <AboutSimpleText>
            ...
            <li>
              Le Conteur Digital (blog de récit de marques pour les entreprises)
              avec Mathias Savary (React/Node/MySQL)
            </li>
          </AboutSimpleText>
