    ...
    <AboutContainer>
      <AboutBloc>
        ...
        <AboutSimpleText>
          ...
          <ul>
            <li>Création et développement d'application sur Angular 6/7 et Ionic
            3/4</li>
             <li> Réalisation de base de données NoSql avec NestJs et
            utilisation de MongoDB </li></li>Methode Agile appliqué
          </ul>
        </AboutSimpleText>
