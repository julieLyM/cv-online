...
import { AboutSimpleText, AboutLittleTitle } from './style/aboutStyle';

import { Point, WorkTitle } from './style/workStyle';
...
export const Formation = () => {
  return (
    <div>
      <FormationContainer>
        <FormationBloc>
          <WorkTitle> EXPÉRIENCE PROFESSIONNELLE</WorkTitle>
