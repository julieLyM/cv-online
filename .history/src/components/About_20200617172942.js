    ...
    <AboutContainer>
      <AboutBloc>
        ...
        <AboutSimpleText>
          ...
          basé en region parisienne (77). J'ai fait le choix de changé de voie
          ...
          Je n'ai jamais oublié cette envie de création et la fierté de construire 
          des sites.
        </AboutSimpleText>
      </AboutBloc>
      <Point>...</Point>
      ...
      <AboutBloc>
        ...
        <AboutSimpleText>
          ...
          également travailler sur du Devops comme Docker et CircleCi. Je suis ouverte à apprendre d'autre technologies s'il le faut.
        </AboutSimpleText>
      </AboutBloc>
      <Point>...</Point>
